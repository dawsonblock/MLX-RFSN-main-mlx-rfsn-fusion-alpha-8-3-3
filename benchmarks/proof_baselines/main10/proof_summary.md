...
Generated: 2026-06-18T07:09:24.246281+00:00
...
## Highlights
- Fastest KV retrieve: 7.88ms (shape=(1, 8, 1024, 64)|k=8|v=8|incoherent=False)
- KV value quality (same run): cos=1.0000, rel_mae=0.0063, max_abs=0.0199
- Best sparse scenario: sparse_topk_075_sink1_recent2 miss=147.82ms, hit=114.83ms, sparse_cos=0.8836324214935303
- Worst sparse scenario: sparse_disabled_by_default hit_mode=dense_requested sparse_cos=None sparse_rel_mae=None
- Dense decode path: miss=139.92ms, hit=111.06ms, mode=dense_requested

## Absolute Quality
- Sparse quality: warn (min=0.4996379017829895, threshold=0.900)
- Quant quality: pass (min=0.9704664349555969, threshold=0.950)
