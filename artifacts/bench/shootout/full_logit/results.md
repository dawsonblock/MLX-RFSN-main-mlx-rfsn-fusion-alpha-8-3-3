...
|-----------|--------|-------------|----------------|------------|-----------------|-----------|
| dense_mlx_baseline | CONTROL | 270.79 | 1.000 | PASS_NO_PROMOTE | no | no |
| mlx_lm_quantized_kv_b8 | CONTROL | 127.41 | 0.500 | FAIL | yes | no |
| rfsn_direct_packed_k8v8_gs64_bs8 | EXPERIMENTAL | 15.10 | 0.500 | PASS_NO_PROMOTE | yes | no |
