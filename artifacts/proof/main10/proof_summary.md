...
Generated: 2026-06-18T05:57:08.833514+00:00
...
## Highlights
- Fastest KV retrieve: 8.83ms (shape=(1, 8, 1024, 64)|k=8|v=8|incoherent=False)
- KV value quality (same run): cos=1.0000, rel_mae=0.0063, max_abs=0.0199
- Best sparse scenario: sparse_topk_075_sink1_recent2 miss=166.81ms, hit=129.74ms, sparse_cos=0.8836324214935303
- Worst sparse scenario: sparse_disabled_by_default hit_mode=dense_requested sparse_cos=None sparse_rel_mae=None
- Dense decode path: miss=159.84ms, hit=131.46ms, mode=dense_requested
